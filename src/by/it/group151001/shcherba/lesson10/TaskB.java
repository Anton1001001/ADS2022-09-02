...
public class TaskB<E>  implements NavigableSet<E> {
    ...
    private E value;
    private by.it.group151001.shcherba.lesson10.TaskB<E> left;
    private by.it.group151001.shcherba.lesson10.TaskB<E> right;
    private void SetKey(by.it.group151001.shcherba.lesson10.TaskB<E> elem){
        this.left = elem.left;
    ...
    public boolean add(E e) {
        if (this.value == null){
            this.value = e;
            this.left = new by.it.group151001.shcherba.lesson10.TaskB<>();
            this.right = new by.it.group151001.shcherba.lesson10.TaskB<>();
            return true;
        }else{
    ...
    public by.it.group151001.shcherba.lesson10.TaskB<E> getMinimumKey(by.it.group151001.shcherba.lesson10.TaskB<E> curr)
    {
    ...
    public by.it.group151001.shcherba.lesson10.TaskB<E> deleteNode(by.it.group151001.shcherba.lesson10.TaskB<E> root, E key)
    {
        // указатель для хранения родителя текущего узла
        by.it.group151001.shcherba.lesson10.TaskB<E> parent = null;

        // начинаем с корневого узла
        by.it.group151001.shcherba.lesson10.TaskB<E> curr = root;
        ...
        else if (curr.left.value != null && curr.right.value != null)
        {
            ...
            by.it.group151001.shcherba.lesson10.TaskB<E> successor = getMinimumKey(curr.right);
        ...
        // Случай 3: удаляемый узел имеет только одного потомка
            ...
            by.it.group151001.shcherba.lesson10.TaskB<E> child = (curr.left.value != null)? curr.left: curr.right;
    ...
    public boolean remove(Object o) {
        by.it.group151001.shcherba.lesson10.TaskB<E> root = deleteNode(this,(E)o);
        this.SetKey( root);
    ...
    public boolean contains(Object o) {
        ...
        {
            by.it.group151001.shcherba.lesson10.TaskB<E> curr = this;
    ...
    public Iterator<E> iterator() {
        ...
        final by.it.group151001.shcherba.lesson10.TaskB<E>[] curr = new by.it.group151001.shcherba.lesson10.TaskB[]{this};
        Iterator<E> iterator = new Iterator<E>() {
            ...
            public E next() {
                ...
                curr[0] = (by.it.group151001.shcherba.lesson10.TaskB<E>) stack.pop();
                by.it.group151001.shcherba.lesson10.TaskB<E> node = curr[0];
                curr[0] = curr[0].right;
    ...
    public int size() {
        ...
        by.it.group151001.shcherba.lesson10.TaskB<E> l = this.left;
        by.it.group151001.shcherba.lesson10.TaskB<E> r = this.right;
        s++;
        if (l.value != null){
            s += l.size();
        }

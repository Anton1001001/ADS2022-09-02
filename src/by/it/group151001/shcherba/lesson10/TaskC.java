package by.it.group151001.shcherba.lesson10;
...
public class TaskC<E>  implements NavigableSet<E> {
    ...
    private E value;
    private by.it.group151001.shcherba.lesson10.TaskC<E> left;
    private by.it.group151001.shcherba.lesson10.TaskC<E> right;
    private void SetKey(by.it.group151001.shcherba.lesson10.TaskC<E> elem){
        this.left = elem.left;
    ...
    public static void main(String[] args) {
        by.it.group151001.shcherba.lesson10.TaskC<Integer> tree = new by.it.group151001.shcherba.lesson10.TaskC<>();
    ...
    public boolean add(E e) {
        if (this.value == null){
            this.value = e;
            this.left = new by.it.group151001.shcherba.lesson10.TaskC<>();
            this.right = new by.it.group151001.shcherba.lesson10.TaskC<>();
            return true;
        }else{
    ...
    public by.it.group151001.shcherba.lesson10.TaskC<E> getMinimumKey(by.it.group151001.shcherba.lesson10.TaskC<E> curr)
    {
    ...
    public by.it.group151001.shcherba.lesson10.TaskC<E> deleteNode(by.it.group151001.shcherba.lesson10.TaskC<E> root, E key)
    {
        // указатель для хранения родителя текущего узла
        by.it.group151001.shcherba.lesson10.TaskC<E> parent = null;

        // начинаем с корневого узла
        by.it.group151001.shcherba.lesson10.TaskC<E> curr = root;
        ...
        else if (curr.left.value != null && curr.right.value != null)
        {
            ...
            by.it.group151001.shcherba.lesson10.TaskC<E> successor = getMinimumKey(curr.right);
        ...
        // Случай 3: удаляемый узел имеет только одного потомка
            ...
            by.it.group151001.shcherba.lesson10.TaskC<E> child = (curr.left.value != null)? curr.left: curr.right;
    ...
    public boolean remove(Object o) {
        by.it.group151001.shcherba.lesson10.TaskC<E> root = deleteNode(this,(E)o);
        this.SetKey( root);
    ...
    public boolean contains(Object o) {
        ...
        {
            by.it.group151001.shcherba.lesson10.TaskC<E> curr = this;
    ...
    public Iterator<E> iterator() {
        ...
        final by.it.group151001.shcherba.lesson10.TaskC<E>[] curr = new by.it.group151001.shcherba.lesson10.TaskC[]{this};
        Iterator<E> iterator = new Iterator<E>() {
            ...
            public E next() {
                ...
                curr[0] = (by.it.group151001.shcherba.lesson10.TaskC<E>) stack.pop();
                by.it.group151001.shcherba.lesson10.TaskC<E> node = curr[0];
                curr[0] = curr[0].right;
    ...
    public int size() {
        ...
        by.it.group151001.shcherba.lesson10.TaskC<E> l = this.left;
        by.it.group151001.shcherba.lesson10.TaskC<E> r = this.right;
        s++;
        if (l.value != null){
            s += l.size();
        }
    ...
    ArrayList<E> inArray(by.it.group151001.shcherba.lesson10.TaskC<E> root, ArrayList<E> arr){
        if (root.value != null) {
            arr.add(root.value);

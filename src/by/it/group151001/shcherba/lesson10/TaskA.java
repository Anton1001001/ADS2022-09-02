...
public class TaskA<E> implements NavigableSet<E> {
    private E value;
    private by.it.group151001.shcherba.lesson10.TaskA<E> left;
    private by.it.group151001.shcherba.lesson10.TaskA<E> right;
    private void SetKey(by.it.group151001.shcherba.lesson10.TaskA<E> elem){
        this.left = elem.left;
    ...
    public static void main(String[] args) {
        by.it.group151001.shcherba.lesson10.TaskA<Integer> tree = new by.it.group151001.shcherba.lesson10.TaskA<>();
        tree.add(8);
        tree.add(7);
        tree.SetKey(null);
    }
    ...
    public boolean add(E e) {
        if (this.value == null){
            this.value = e;
            this.left = new by.it.group151001.shcherba.lesson10.TaskA<>();
            this.right = new by.it.group151001.shcherba.lesson10.TaskA<>();
            return true;
        }else{
    ...
    public by.it.group151001.shcherba.lesson10.TaskA<E> getMinimumKey(by.it.group151001.shcherba.lesson10.TaskA<E> curr)
    {
    ...
    public by.it.group151001.shcherba.lesson10.TaskA<E> deleteNode(by.it.group151001.shcherba.lesson10.TaskA<E> root, E key)
    {
        // указатель для хранения родителя текущего узла
        by.it.group151001.shcherba.lesson10.TaskA<E> parent = null;

        // начинаем с корневого узла
        by.it.group151001.shcherba.lesson10.TaskA<E> curr = root;
        ...
        else if (curr.left.value != null && curr.right.value != null)
        {
            ...
            by.it.group151001.shcherba.lesson10.TaskA<E> successor = getMinimumKey(curr.right);
        ...
        // Случай 3: удаляемый узел имеет только одного потомка
            ...
            by.it.group151001.shcherba.lesson10.TaskA<E> child = (curr.left.value != null)? curr.left: curr.right;
    ...
    public boolean remove(Object o) {
        by.it.group151001.shcherba.lesson10.TaskA<E> root = deleteNode(this,(E)o);
        this.SetKey( root);
